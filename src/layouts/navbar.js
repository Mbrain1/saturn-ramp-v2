...
export default function Navbar({ isContainer }) {

    const [show, setShow] = useState(false);

    return (
        <header className="bg-blue-500  w-full py-5">
           <nav className={`${isContainer && 'container'} flex justify-between items-center text-white text-lg font-medium relative z-10`}>
